# There is a huge hotel consisting of three buildings, 15 floors each.
# There are 20 rooms on each floor. For this, you need an array which can collect and process information on the occupied/free rooms.
